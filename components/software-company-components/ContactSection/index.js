              ...
              <ul className="contact_method_list unordered_list_block">
                <li>
                  <a href="tel:+8801680636189">
                    ...
                    <span className="text">+1 (647) 915-1599</span>
                  </a>
                </li>
                <li>
                  <a href="mailto:Techco@gmail.com">
                    ...
                    <span className="text">info@ebaaddigital.com</span>
                  </a>
                </li>
                <li>
                  <a href="#!">
                    ...
                    <span className="text">342 Silver Court, Milton, Ontario L9t 0N2, Canada</span>
                  </a>
                </li>
              </ul>

          ...
          <div className="row justify-content-lg-between">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="footer_widget">
                ...
                <ul className="icon_list unordered_list_block">
                  <li>
                    <Link onClick={ClickHandler} href="/service-single/Web Development">
                      <span className="icon_list_text">Web Development</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={ClickHandler} href="/service-single/App Development">
                      <span className="icon_list_text">App Development</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={ClickHandler} href="/service-single/Digital Marketing">
                      <span className="icon_list_text">Digital Marketing</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={ClickHandler} href="/service-single/UI-UX Designing">
                      <span className="icon_list_text">UI/UX Designing</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={ClickHandler} href="/service-single/WordPress Development">
                      <span className="icon_list_text">WordPress Development</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={ClickHandler} href="/service-single/Graphic Designing">
                      <span className="icon_list_text">Graphic Designing</span>
                    </Link>
                  </li>
                </ul>
              </div>
      ...
      >
        <div className="container d-md-flex align-items-md-center justify-content-md-between">
          <p className="copyright_text m-0">
            Copyright © 2024 Ebaad Digital, All rights reserved.
          </p>

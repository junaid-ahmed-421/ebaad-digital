...
// import logo from "/public/images/site_logo/white.png";
// import logo2 from "/public/images/site_logo/blue.png";
import logo from "/public/images/site_logo/final-logo-light.png";
import logo2 from "/public/images/site_logo/final-logo-dark.png"
          ...
          <div className="row align-items-center">
            <div className="col-xl-3 col-lg-2 col-5">
              <div className="site_logo">
                <Link onClick={ClickHandler} className="site_link" href="/home_software_company">
                  <Image
                    src={logo}
                    style={{ width: "80px" }}
                    ...
                    <li className="dropdown">
                      ...
                      >
                        <li>
                          <Link
                            onClick={ClickHandler}
                            href="/service-single/Web Development"
                          >
                            Web Development
                          </Link>
                        </li>
                        <li>
                          <Link
                            onClick={ClickHandler}
                            href="/service-single/App Development"
                          >
                            App Development
                          </Link>
                        </li>
                        <li>
                          <Link
                            onClick={ClickHandler}
                            href="/service-single/Digital Marketing"
                          >
                            Digital Marketing
                          </Link>
                        </li>
                        <li>
                          <Link
                            onClick={ClickHandler}
                            href="/service-single/UI-UX Designing"
                          >
                            UI/UX Designing
                          </Link>
                        </li>
                        <li>
                          <Link
                            onClick={ClickHandler}
                            href="/service-single/WordPress Development"
                          >
                        ...
                        <li>
                          <Link
                            onClick={ClickHandler}
                            href="/service-single/Graphic Designing"
                          >
                            Graphic Designing
                          </Link>
                        </li>
